        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <div className="d-flex gap-3 fs-4">
              <a
                href="#"
                className="text-decoration-none text-primary hover-opacity"
              >
                <RiFacebookFill />
              </a>
              <a
                href="#"
                className="text-decoration-none text-danger hover-opacity"
              >
                <AiOutlineInstagram />
              </a>
              <a
                href="#"
                className="text-decoration-none text-info hover-opacity"
              >
                <AiOutlineTwitter />
              </a>
              <a
          ...
          <div className="col-md-3 mb-4 border-start border-2 border-light ps-4">
            ...
            <ul className="list-unstyled">
              <li>
                <Link
                  to="/"
                  className="text-decoration-none text-dark hover-text-success"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="col-md-3 mb-4 border-start border-2 border-light ps-4">
            ...
            <ul className="list-unstyled">
              <li>
                <strong>Email: nhom8@gmail.com</strong>
              </li>
              <li>
                <strong>Hotline:</strong> 0123 456 789
              </li>
              <li>
                <strong>Address:</strong> 33 Xô Viết Nghệ Tĩnh, Đà Nẵng
              </li>
              <li>
                <strong>Payment:</strong> Visa, MasterCard, Momo
              </li>
            </ul>
          </div>
        </div>
